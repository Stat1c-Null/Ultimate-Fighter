...
p1 = instance_create_layer(room_width/2-100, 220, "Characters", o_player_ryo)//Spawn character in the middle of the room
p2 = instance_create_layer(room_width/2+100, 220, "Characters", o_player_ryo)
